...
exports.config = {
  ...
  specs: [
    "test/features/GUI/smoke_Test/Acceptance.feature"
  ],
  ...
  cucumberOpts: {
    ...
    // tagExpression: "@CheckingYourEligibilityDecline", // <string> (expression) only execute the features or scenarios with tags matching the expression, see https://docs.cucumber.io/tag-expressions/
